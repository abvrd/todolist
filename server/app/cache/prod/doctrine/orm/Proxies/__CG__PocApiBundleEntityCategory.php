 ...
 */
class Category extends \Poc\ApiBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', 'color', 'description', '' . "\0" . 'Poc\\ApiBundle\\Entity\\Category' . "\0" . 'task');
        }
