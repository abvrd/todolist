...
namespace Proxies\__CG__\Poc\ApiBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Task extends \Poc\ApiBundle\Entity\Task implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'label', 'date', '' . "\0" . 'Poc\\ApiBundle\\Entity\\Task' . "\0" . 'categories', 'description', '' . "\0" . 'Poc\\ApiBundle\\Entity\\Task' . "\0" . 'children', '' . "\0" . 'Poc\\ApiBundle\\Entity\\Task' . "\0" . 'parent', '' . "\0" . 'Poc\\ApiBundle\\Entity\\Task' . "\0" . 'done');
        }
